...
When you are finished, click the OK button. The program will warn you that RTL433 must be started/restarted for changes to take effect. Click anywhere to dismiss the message and then click "Start RTL433". It should launch the rtl_433 tool in the background and start looking for your weather sensor telemetry. Click OK again and you should be good to go!
